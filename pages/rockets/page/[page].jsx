            ...
            >
                ...
                <CardContent>
                    ...
                    >
                        ...
                        {/* List out 10 (max) rockets with their serial id; clicking the list item would lead to its specific id page*/}
                        <div>
                            <ul>
...
export async function getStaticProps({ params }) {
    ...
    console.log(pageNo);
    const data = await getTenRocketsData(pageNo); // call function with specific page number
...
// get ten rockets and their data
async function getTenRocketsData(page) {
    let adjustedPage = 0;
    if (page === 0) {
        adjustedPage = 1;
    }
...
// get all rockets and their data
...
export async function getStaticPaths() {
    ...
    const totalRockets = data.length; // counts how many rockets are listed in the api
    const totalPages = Math.ceil(totalRockets / 10); // counts how many pages is necessary (10 rockets per page)
